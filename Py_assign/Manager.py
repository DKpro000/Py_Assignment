...
class Manager:
    ...
    def delete(self, accID):
        ...
        if len(new_users) < len(users):
            ...
            print(f"The administrator has removed user: {accID}.")
        else:
            print(f"No user named {accID} found.")
    ...
    def update_order_status(self, order_id, new_status):
        ...
        for idx, o in enumerate(orders_data['orders']):
            ...
            if new_status == "Cancelled":
                ...
                print(f"Cancelled and removed order {order_id}")
                return
    ...
    def print_all_ingredients(self, ManagerWindow):
        ...
        return TableCreator(ManagerWindow,"Ingredients inventory list (stock <= threshold 的项目会加粗显示)：",
    ...
    def list_feedback(self,ManagerWindow):
        ...
        for fb in fk.get('feedback', []):
            ...
            tempFeedbackList.append(fb['order_id'])
            ...
            tempFeedbackList.append(fb['time'])
        TableCreator(feedbackFrame,"Feedbacks",("ID","OrderID","CustomerID","DishID","Rating","Comment","Time"),tempFeedbackList)
...
def manager_interface(mgr,MainWindow):
    ...
    while True:
        ...
        if cmd == '1':
                ...
                if sub_choice == '1':
                    ...
                    if option == '1':
                        ...
                        if not pid_data or not pid_data[0].isdigit():
                            ...
                            pid = int(pid_data[0])  # now safely convert
            ...
            mgr.list_feedback(ManagerWindow)
        elif cmd == '6':
